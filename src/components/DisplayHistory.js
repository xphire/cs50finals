                            ...
                            rows.map((item,index) => {
                                ...
                                return (
                                    ...
                                    <TableRow key={item.id}>
                                        ...
                                        <TableCell align='center'>
                                        <Button className='py-3 text-nowrap' href={item.qr} id={item.id} target='_blank' download= {item.url} variant="contained"  size ="large"  endIcon={<DownloadIcon />} >DOWNLOAD QR </Button>
                                        </TableCell> 
                                    </TableRow>
                                )
                            })
